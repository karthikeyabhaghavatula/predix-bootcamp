...
Starting services:
    1) Start the Predix Http Tunnel Server by running "tunnelServer.bat". Enter the keystore password when prompted.
    2) Start the Predix Machine by navigating to the <container>/bin/ and running "start_predixmachine.bat"
